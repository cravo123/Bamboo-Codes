...
def GrabInsiderTrade(pth, startPage, interval = 2):
    ...
    for k in range(startPage, startPage + interval):
        url = 'http://www.szse.cn/main/disclosure/jgxxgk/dxjy/'
...
#        print(data)
    ...
    df.columns = ['Ticker', 'Stock','Shareholder', 'ManagementLevel','Date', 'Action', 'NumOfShares', 'Price']
    df = df[['Ticker', 'Stock', 'Date', 'Action', 'NumOfShares', 'Price', 'Shareholder', 'ManagementLevel']]
...
if __name__ == '__main__':
    aa = GrabInsiderTrade(r'C:\Users\Chong\Desktop\Bamboo Strategy\InsiderTrade',1)